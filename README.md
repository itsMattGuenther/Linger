...
The [0.3.5 release notes](docs/releases/0.3.5.md) cover faster typing and
scrolling on Linux, clearer replies, lighter long rooms, the reactions trial and
rail fixes since 0.3.4, upgrade steps, and the checks still open for this testing
release.
