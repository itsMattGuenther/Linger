...
**Amended (Matt, 2026-08-27 — [`docs/decisions.md`](../decisions.md)): M7
...
- ✅ **T-701 · Updater + signing keys** — effort: **high** — landed 2026-08-27
  ...
  **Releases are draft-first.** A tag builds Linux, Windows and both macOS
  ...
  > this note still holds. See [`docs/decisions.md`](../decisions.md) and
  > T-705.
...
- ✅ **T-703 · Server image publish** — effort: **low** — landed 2026-08-27
  ...
  **Landing note.** `.github/workflows/image.yml` publishes the server to
  `ghcr.io/itsmattguenther/linger`, which is the name `deploy/compose.yaml`
...
sign-off, and pulling `ghcr.io/itsmattguenther/linger` on a real box is the
